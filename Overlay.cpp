...
Overlay::Overlay()
    : g_pd3dDevice(nullptr), g_pd3dDeviceContext(nullptr), g_pSwapChain(nullptr), g_mainRenderTargetView(nullptr) {
}
...
LRESULT WINAPI Overlay::HandleMessage(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
